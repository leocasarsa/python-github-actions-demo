...
├── python_github_actions_demo             # The main python package for the project
...
e.g: `cat python_github_actions_demo/VERSION` will get the project version without harming
